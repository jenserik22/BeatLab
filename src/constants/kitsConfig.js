    ...
    drums: {
      ...
      'Closed Hi-Hat': {
        ...
        effects: [
          {
            type: 'Filter',
            options: [{ frequency: 8000, type: 'highpass' }],
            connectTo: 'target'
          }
        ]
      },
      'Open Hi-Hat': {
        ...
        effects: [
          {
            type: 'Filter',
            options: [{ frequency: 6000, type: 'highpass' }],
            connectTo: 'target'
          }
        ]
      },
    ...
    drums: {
      ...
      'Closed Hi-Hat': {
        ...
        effects: [
          {
            type: 'Filter',
            options: [{ frequency: 10000, type: 'highpass' }],
            connectTo: 'target'
          }
        ]
      },
      'Open Hi-Hat': {
        ...
        effects: [
          {
            type: 'Filter',
            options: [{ frequency: 9000, type: 'highpass' }],
            connectTo: 'target'
          }
        ]
      },
    ...
    drums: {
      ...
      'Closed Hi-Hat': {
        ...
        effects: [
          {
            type: 'Filter',
            options: [{ frequency: 7000, type: 'highpass' }],
            connectTo: 'target'
          }
        ]
      },
